...
<html>
<head><title> Sign Up Company User</title></head>
<left><body background = "background_guitar.jpg"> 
<h2>  Sign Up Company User!</h2>
<form action ="SignUp_Company_Representative.php" method="post" >

	<b>Sign Up One Company User</b>
	...
	<p>Company Name:
	<input type = "text" name="companyName" size = "30" value="">
	</p>
...
if(isset($_POST['submit'])) {
	...
	if (empty($_POST['companyName'])) {
		...
		$u_company = trim($_POST['companyName']);
	}
