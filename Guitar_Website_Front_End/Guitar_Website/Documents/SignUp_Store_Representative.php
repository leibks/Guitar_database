...
<html>
<head><title> Sign Up Store User</title></head>
<left><body background = "background_guitar.jpg"> 
<h2>  Sign Up Store User!</h2>
<form action ="SignUp_Store_Representative.php" method="post" >

	<b>Sign Up One Store User</b>
	...
	<p>Store Name:
	<input type = "text" name="storeName" size = "30" value="">
	</p>
...
if(isset($_POST['submit'])) {
	...
	if (empty($_POST['storeName'])) {
		$data_missing[] = 'Store Name';
	} else {
		$u_store = trim($_POST['storeName']);
	}
