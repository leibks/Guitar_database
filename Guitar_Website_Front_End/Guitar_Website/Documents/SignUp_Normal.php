...
<html>
<head><title> Sign Up Normal User</title></head>
<left><body background = "background_guitar.jpg"> 
<h2>  Sign Up Normal User!</h2>
<form action ="SignUp_Normal.php" method="post" >

	<b>Sign Up One Normal User</b>
...
if(isset($_POST['submit'])) {
	...
	$query = "Call signUpNormal(?, ?, ?, ?, ?, ?, ? );";
	
	$stmt = mysqli_prepare($dbc, $query);
	
	mysqli_stmt_bind_param($stmt, "ssisssi", $u_name, $u_pass, 
